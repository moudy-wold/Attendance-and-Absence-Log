...
export default {
  ...
  "Leave empty to use the phone number": "اتركه فارغًا لاستخدام رقم الهاتف",
  "If left empty, the phone number will be used as the password.":
    "إذا تُرك فارغًا، سيصبح رقم الهاتف هو كلمة المرور.",
  ...
  "Employee type (optional)": "نوع الموظف (اختياري)",
  "Employee type must be a number": "نوع الموظف يجب أن يكون رقمًا",
